...
class ChatInterface(Frame):
    ...
    def msg(self):
        tkinter.messagebox.showinfo("Bot v1.0",
                                    'Bot is a chatbot for answering the user questions about college.')

    def about(self):
        tkinter.messagebox.showinfo("Bot Developers",
                                    "1.Eesha\n2.Sravya\n3.Varshith\n4.Ranadeep")

    def send_message_insert(self, message):
        user_input = self.entry_field.get()
        pr1 = "Client : " + user_input + "\n"
